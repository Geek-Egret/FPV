...
def generate_launch_description():
    ...
    odometry_topic = LaunchConfiguration('odometry_topic', default='cuvslam/odom')
    camera_pose_topic = LaunchConfiguration('camera_pose_topic', default='cuvslam/pose')
    ...
    fx = LaunchConfiguration('fx', default=455.483)
    fy = LaunchConfiguration('fy', default=455.483)
    ...
    ego_planner_node = Node(
        ...
        parameters=[
            ...
            {'grid_map/frame_id': "camera_optical_frame"},
            # planner manager
            {'manager/max_vel': max_vel},
            {'manager/max_acc': max_acc},
            {'manager/max_jerk': 4.0},
            {'manager/control_points_distance': 0.1},
    ...
    # traj_server: B样条 -> 位置指令 /position_cmd
